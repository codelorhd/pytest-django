...
urlpatterns = [
    path("student/list/", views.StudentListAPIView.as_view(), name="student_list_api"),
    path(
        "student/create/",
        views.StudentCreateAPIView.as_view(),
    ...
    path(
        ...
        views.StudentDeleteAPIView.as_view(),
        name="student_delete_api",
    ),
    path(
        "classroom/<int:capacity>",
        views.ClassRoomStudentCount.as_view(),
